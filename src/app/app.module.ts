...
import { ConfirmSquarekleCardContainerComponent } from './confirm-squarekle-card-container/confirm-squarekle-card-container.component';
...
@NgModule({
  declarations: [
    ...
    ConfirmSquarekleCardContainerComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
